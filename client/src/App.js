...
import Feedback from "./components/Dashbord/Feedback";
import Result from "./components/Dashbord/composebox/Result";
import Singlemail from "./components/Dashbord/composebox/Singlemail";
...
import Allmails from "./components/EmailInbox/Allmails";
import AttendenceMail from "./components/EmailInbox/Attendence";
// import account from "./components/Appwrite/appwriteConfig";
import Resultmail from "./components/EmailInbox/Resultmail";
function App() {
  // console.log("account");
    ...
    <div className="App">
      <Router>
        <Routes>
          ...
          <Route path="/attendance-mail" element={<AttendenceMail />} />
